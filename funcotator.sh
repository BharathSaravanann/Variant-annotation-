...
#need to store all vcf files generated after variant calling
...
#filtering variants after variant calling to avoid false positive
...
# exclude variants on INDELS vcf file
...
gatk Funcotator \
	...
	--reference ${ref} \
	--ref-version hg38 \
	--data-sources-path /home/bharath/germline/funcotator_dataSources.v1.8.hg38.20230908g \
